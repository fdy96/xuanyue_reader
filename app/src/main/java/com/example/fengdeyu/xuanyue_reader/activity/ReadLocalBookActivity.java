...
public class ReadLocalBookActivity extends AppCompatActivity implements MyReadInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_local_book);
        ...
        iv_font_typeface.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(ReadLocalBookActivity.this,TypefaceSelectActivity.class));
...
//                }
    ...
    protected void onDestroy() {
        ...
        Log.i("rate",GetPageAttribute.getInstance().rate+"");
...
//                Log.i("info",doc.toString());
        ...
        protected void onPostExecute(String contents) {
            ...
            if(contents!=null) {
                ...
                GetPageAttribute.getInstance().chapterName=GetBookCase.getInstance().mList.get(bookId).bookTitle;
